    ...
    <div className="min-h-screen bg-gray-50 p-6">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          ...
          <div className="bg-white border-2 border-dashed border-blue-300 rounded-xl p-8 flex flex-col items-center justify-center hover:border-blue-400 transition cursor-pointer">
              ...
              <div className="p-6">
                ...
                <div className="flex items-center gap-4 mb-4 text-sm text-gray-600">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <span>
                      {votacion.fechaInicio} / {votacion.fechaFin}
                    </span>
                  </div>
                </div>
                ...
                <div className="flex gap-2">
                  <button
                    ...
                    className="flex-1 cursor-pointer flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
                  ...
                  <button
                    onClick={() =>
                      navigate(`/admin/editar-votacion/${votacion.id}`)
                    }
                    className="cursor-pointer flex items-center justify-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 transition text-sm"
                  >
                    <svg
                      className="w-4 h-4"
                      fill="none"
